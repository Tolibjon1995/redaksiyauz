            ...
            <div class="card">
                <div class="card-body">
                    <div class="border p-3 rounded">
                        ...
                        <hr>
                        <form action="{{ route('admin.post.store') }}" class="row g-3" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="editor" type="text" name="body_uz" class="form-control" id="ckeditor1"></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Post body RU</label>
                                <textarea id="editor2" type="text" name="body_ru" class="form-control" id="ckeditor1"></textarea>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <select name="category_id" class="form-control">
                                    <option value="">Kategoriyalarni tanglang</option>
